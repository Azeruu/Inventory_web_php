...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="laporan.php">Laporan</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data keseluruhan stok barang</h1>
                
                        <div class="card mb-4">
                            <div class="card-header">
                            <a href="expLaporan.php" class="btn btn-info">Export Data</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered" id="datatablesSimple" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            while($data=mysqli_fetch_array($ambilsemuadata)){
                                                ...
                                                $kodebarang = $data['kode_barang'];
                                                $barangmasuk = $data['jumlah_barang_masuk'];
                                    ...
                                    <table class="table table-bordered" id="datatablesSimple" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            while($data=mysqli_fetch_array($ambilsemuadata)){
                                                ...
                                                $kodebarang = $data['kode_barang'];
                                                $barangkeluar = $data['jumlah_barang_keluar'];
